...
public enum MimeTypes {
	...
	// text
	TEXT_HTM(".htm", "text/html"), TEXT_HTML(".html", "text/html"), TEXT_PLAIN(
			".txt", "text/plain"), TEXT_XML(".xml", "text/xml"), TEXT_XSL(
			".xsl", "text/xml"), TEXT_JSON(".json", "text/json"), TEXT_CSS(
			".css", "text/css"),

	// image
	IMAGE_GIF(".gif", "image/gif"), IMAGE_JPG(".jpg", "image/jpeg"), IMAGE_PNG(
			".png", "image/png"), IMAGE_BMP(".bmp", "image/bmp"),
